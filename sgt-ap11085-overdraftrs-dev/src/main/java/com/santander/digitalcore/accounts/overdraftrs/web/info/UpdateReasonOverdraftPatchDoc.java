...
@Operation(
		description = "Updates an Overdraft reason with the information provided in the request parameter.",
		summary = "Update Reason Overdraft")
@ApiResponses(value = {
...
public @interface UpdateReasonOverdraftPatchDoc {
