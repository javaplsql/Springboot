...
/**
 * Annotation to document the code operator Overdraft delete method
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Operation(
    description = "Deletes an Overdraft code operator",
    summary = "Delete Code Operator Overdraft")
@ApiResponses(value = {
...
public @interface DeleteOperatorReasonOverdraftDoc {
