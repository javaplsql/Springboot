...
/**
 * Annotation to document the code reason Overdraft delete method
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Operation(
    description = "Deletes an Overdraft code reason",
    summary = "Delete Code Reason Overdraft")
@ApiResponses(value = {
...
public @interface DeleteCodeReasonOverdraftDoc {
